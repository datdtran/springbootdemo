...
public class Student {
    ...
    private Integer age;
    @ApiModelProperty(notes = "Date of birth of student", name = "dob", required = true, value = "2008-05-16")
    private LocalDate dob;
    @ApiModelProperty(notes = "Email of student", name = "email", required = true, value = "Sohee@gmail.com")
